...
var hats = new Tone.Sampler({
  "url" : "https://raw.githubusercontent.com/Tonejs/Tone.js/master/examples/audio/505/hh.mp3",
  "volume" : -10,
  "envelope" : {
    "attack" : 0.001,
    "decay" : 0.02,
...
var snare = new Tone.Sampler({
  "url" : "https://raw.githubusercontent.com/Tonejs/Tone.js/master/examples/audio/505/snare.mp3",
  "envelope" : {
    "attack" : 0.01,
    "decay" : 0.05,
    "sustain" : 0
